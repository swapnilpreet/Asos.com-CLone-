      ...
      <Flex className={styles.wrapper} w='60%' justifyContent={'center'}>
        <ul className={styles.navLink}>
          ...
          <li>
            ...
            >
              <Link className={styles.Link} to={"/men-sale"} >
                <Text
                fontSize={'xs'}
              >
                Sale
          ...
          <li>
            <Flex
              ...
              h="49px"
            >
              <Link className={styles.Link} to="/men-newIn">
          ...
          <li>
            <Flex
              ...
              h="49px"
            >
              <Link className={styles.Link} to="/men-cloth">
          ...
          <li>
            <Flex
              ...
              h="49px"
            >
              <Link className={styles.Link} to="/men-shoe">
...
Loafers
          ...
          <li>
            <Flex
              ...
              h="49px"
            >
              <Link className={styles.Link} to="/men-accessories">
          ...
          <li>
            ...
            <Flex
              ...
              h="49px"
            >
              <Link className={styles.Link} to="/men-sportwear">
          ...
          <li>
            <Flex
              ...
              h="49px"
            >
              <Link className={styles.Link} to="/men-topshop">
          ...
          <li>
            <Flex
              ...
              h="49px"
            >
              <Link className={styles.Link} to="/men-summer">
          ...
          <li>
            <Flex
              ...
              h="49px"
              mr={2}
            ><Link className={styles.Link} to="/men-brand">
          ...
          <li>
            <Flex
              ...
              h="49px"
            >
              <Link className={styles.Link} to="/men-outlet">
              <Text
                transform={"skew(10deg)"}
