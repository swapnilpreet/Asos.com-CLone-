...
const WomensubMenu = () => {
  ...
  return (
    <Box w="100%" h={"50px"} bgColor={"#525050"} className={styles.nav}>
      <Flex  className={styles.wrapper}  w='60%' justifyContent={'center'}>
        <ul className={styles.navLink}>
          ...
          <li>
            <Flex
              ...
              h="49px"
            >
              <Link className={styles.Link} to={"/women-newIn"}>
                {" "}
                <Text
                fontSize={'xs'}
                  transform={"skew(10deg)"}
          ...
          <li>
            ...
            >
              <Link className={styles.Link} to="/women-newIn">
                <Text fontSize={'xs'} _hover={{ bgColor: "white", color: "black",}} >
                  New in
                </Text>
              </Link>
            </Flex>
          ...
          <li>
            <Flex
              ...
              h="49px"
            >
              <Link className={styles.Link} to={"/women-cloth"}>
                <Text fontSize={'xs'} _hover={{ bgColor: "white", color: "black" }}>
                  Clothing
                </Text>
              </Link>
          ...
          <li>
            <Flex
              ...
              h="49px"
            >
              <Link className={styles.Link} to={"/women-dresses"}>
                <Text fontSize={'xs'} _hover={{ bgColor: "white", color: "black" }}>
                  Dresses
                </Text>
              </Link>
          ...
          <li>
            <Flex
              ...
              h="49px"
            >
              <Link  className={styles.Link} to={"/women-shoe"}>
                <Text fontSize={'xs'} _hover={{ bgColor: "white", color: "black" }}>Shoes</Text>
              </Link>
            </Flex>
            <Box className={styles.megaBox}>
              <Box className={styles.content}>
          ...
          <li>
            <Flex
              ...
              h="49px"
            >
              <Link className={styles.Link} to="/women-sportwear">
                <Text fontSize={'xs'} _hover={{ bgColor: "white", color: "black" }}>
                  Sportwear
                </Text>
              </Link>
          ...
          <li>
            <Flex
              ...
              h="49px"
            >
              <Link className={styles.Link} to={"/women-accessories"}>
                <Text fontSize={'xs'} _hover={{ bgColor: "white", color: "black" }}>
                  Accessories
                </Text>
              </Link>
          ...
          <li>
            <Flex
              ...
              justifyContent={"center"}
              h="49px"
            ><Link to="/women-summer">
              <Text fontSize={'xs'}  _hover={{ bgColor: "white", color: "black" }}>Summer</Text>
              </Link>
              <div className={styles.megaBox}>
                <div className={styles.content}>
                  <div className={styles.row}>
          ...
          <li>
            <Flex
              ...
              h="49px"
            >
              <Link className={styles.Link} to={`/women-topshop`}>
              <Text fontSize={'xs'} _hover={{ bgColor: "white", color: "black" }}>Topshop</Text>
              </Link>
              <div className={styles.megaBox}>
              <div className={styles.content}>
                <div className={styles.row}>
          ...
          <li>
            <Flex
              ...
              h="49px"
            >
              <Link className={styles.Link} to={"/women-facebody"}>
          ...
          <li>
            <Flex
              ...
              mr={2}
            >
              <Link className={styles.Link} to="/women-brands">
          ...
          <li>
            <Flex
              ...
              h="49px"
            >
              <Link className={styles.Link} to={"/women-outlet"}>
              <Text
              fontSize={'xs'}
                transform={"skew(10deg)"}
          ...
          {/* <li>
            <Flex
              ...
              h="49px"
            >
              <Link className={styles.Link} to="/women-marketplace">
